...
class ObjectSelector:
    ...
    def select_topk_object(self, **kwargs):
        ...
        if use_force_selestion:=True: #* useful, HO3Dv2-ADDS: 15.35 -> 14.15
            ...
            pose6d_fused = self.fuse_topk(topk=new_topk, weight=new_weight, **kwargs)
        else:
            trans2 = self.fuse_topk(topk=topk_trans2, weight=weight_trans2, **kwargs)[:, 6:]
            rot2 = self.fuse_topk(topk=topk_rot2, weight=weight_rot2, **kwargs)[:, :6]
