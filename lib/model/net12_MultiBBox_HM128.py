...
class DiffHandObj_MultiBBox_HM128(nn.Module):
    def __init__(self):
        super(DiffHandObj_MultiBBox_HM128, self).__init__()
        self.cfg = cfg
        ...
        self.head_hm_hand = HeadHeatmap2(256, 21, 256, num_deconv_layer=2)
        self.head_hm_obj = HeadHeatmap2(256, 27, 256, num_deconv_layer=2)
